// 3종 AI 호출 mock: 키 없음/실패 시 폴백. 대사 템플릿은 @eotm/content(global/strings.json)에서 읽는다.
// 원본 server/sycophant/mock.js 이식 — 로직 동일.
import { STRINGS, fmt, type FullPersona } from '@eotm/content';
import type { Situation } from '@eotm/shared';
