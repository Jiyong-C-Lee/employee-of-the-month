...
import { ADVISOR_SPEECH_MAX_CHARS } from '@shared';
import { mockAdvisorTurnsBatch, mockJudgeSpeeches, mockEpilogue } from '../ai/mock';
import { trimSpeech, finalizeVerdict } from '../ai/verdict';
import { advisorBatchOut } from '../ai/schemas';
